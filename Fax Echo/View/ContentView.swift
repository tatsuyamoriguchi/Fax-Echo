...
#Preview {
    ...
    ContentView(authManager: AuthenticationManager(), localCredential: LocalCredential(email: "brian@beckos.com", password: "kanda123", appid: "1234", apikey: "abcd", userid: "OneTwoThree"))
}
